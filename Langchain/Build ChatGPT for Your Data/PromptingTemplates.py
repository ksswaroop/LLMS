...
system_prompt_template=SystemMessagePromptTemplate.from_template("You are an expert in {SUBJECT}, and you're currently feeling {MOOD}")
#user_prompt_template="{CONTENT}"
user_prompt_template=HumanMessagePromptTemplate.from_template("{CONTENT}")
...
#disp_markdown(chat_model.invoke(messages))
